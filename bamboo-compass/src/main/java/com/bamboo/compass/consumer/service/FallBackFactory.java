 ...
 * @Description TODO
 * @Author victor su
 * @Date 2019/7/25 21:04
 **/
@Component
public class FallBackFactory implements FallbackFactory<DepartService> {
    @Override
    public DepartService create(Throwable cause) {
        return new DepartService() {
            ...
            public Object discoveryHandle() {
                System.out.println("执行discoveryHandle()的服务降级处理方法");
                return null;
            }

            @Override
            public String portHandle() {
                System.out.println("执行portHandle()的服务降级处理方法");
                return null;
            }
        };
    }
