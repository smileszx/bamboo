...
public class ZookeeperDemo {
    ...
    public ZooKeeper zkConnect( ) throws IOException {
        //zookeeper的ip:端口
        String path = "192.168.1.101:2181";
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        //创建znode
        zookeeperDemo.createZnode("/zk_test", "suzhengxiao".getBytes(), null, CreateMode.PERSISTENT);
        //获取znode的值
        String znodeValue = zookeeperDemo.getZnodeValue("/zk_test");
